...
class AddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .post("/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "description":"SAMPLE_TEXT", "line1":"SAMPLE_TEXT", "line2":"SAMPLE_TEXT", "line3":"SAMPLE_TEXT", "line4":"SAMPLE_TEXT", "zipCode":"SAMPLE_TEXT", "state":"SAMPLE_TEXT", "validFrom":"2020-01-01T00:00:00.000Z", "validTo":"2020-01-01T00:00:00.000Z", "comments":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
