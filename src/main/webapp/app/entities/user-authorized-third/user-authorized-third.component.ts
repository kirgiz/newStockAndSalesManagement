...
export class UserAuthorizedThirdComponent implements OnInit, OnDestroy {
    userAuthorizedThirds: IUserAuthorizedThird[];
    currentAccount: any;
    ...
    loadAll() {
        this.userAuthorizedThirdService
            .query({
                page: this.page,
            ...
            .subscribe(
                (res: HttpResponse<IUserAuthorizedThird[]>) => this.paginateUserAuthorizedThirds(res.body, res.headers),
    ...
    trackId(index: number, item: IUserAuthorizedThird) {
        return item.id;
    }
    ...
    private paginateUserAuthorizedThirds(data: IUserAuthorizedThird[], headers: HttpHeaders) {
